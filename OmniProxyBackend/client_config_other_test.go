...
func TestWriteOpenCodeConfigAddsOmniProxyProviders(t *testing.T) {
	...
	if routerModels["gpt-6-astra"] == nil || routerModels["gpt-6-sol"] == nil || routerModels["gpt-6-luna"] == nil || routerModels["gpt-5.6-sol"] == nil || routerModels["gpt-5.6-terra"] == nil || routerModels["gpt-5.6-luna"] == nil || routerModels["openai/gpt-test"] == nil || routerModels["auto:balance"] == nil || routerModels["custom-model"] == nil {
