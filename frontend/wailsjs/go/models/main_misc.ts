export namespace main {
	...
	export class codexUsageActivationResponse {
	    token: tokenResponse;
	    activated: boolean;
	    alreadyActive: boolean;
	    beforePrimaryResetAt?: number;
	    beforeSecondaryResetAt?: number;
	    afterPrimaryResetAt?: number;
	    afterSecondaryResetAt?: number;
	    message: string;

	    static createFrom(source: any = {}) {
	        return new codexUsageActivationResponse(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.alreadyActive = source["alreadyActive"];
	        this.beforePrimaryResetAt = source["beforePrimaryResetAt"];
	        this.beforeSecondaryResetAt = source["beforeSecondaryResetAt"];
	        this.afterPrimaryResetAt = source["afterPrimaryResetAt"];
	        this.afterSecondaryResetAt = source["afterSecondaryResetAt"];
	        this.message = source["message"];
	    }
