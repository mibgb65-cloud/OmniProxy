...
export const priceRules = [
  { pattern: /^gpt-6-astra(?:$|-)/i, label: 'OpenAI GPT-6 Astra', currency: 'USD', input: 10, output: 50, cacheCreation: 12.5, cacheRead: 1, ...gpt54LongContext },
  { pattern: /^gpt-6-sol(?:$|-)/i, label: 'OpenAI GPT-6 Sol', currency: 'USD', input: 2, output: 10, cacheCreation: 2.5, cacheRead: 0.2, ...gpt54LongContext },
  { pattern: /^gpt-6-luna(?:$|-)/i, label: 'OpenAI GPT-6 Luna', currency: 'USD', input: 0.1, output: 0.5, cacheCreation: 0.125, cacheRead: 0.01, ...gpt54LongContext },
